...
<div class="container-fluid">
  <div class="page-content__header">
    <div>
      <h2 class="page-content__header-heading">DETAIL PENCARI KERJA</h2>
    </div>
  </div>
  <div class="row">
    <div class="col-lg-6">
  ...
  <div class="row">
    <div class="col-lg-4">
        <div>
        <img src="img/users/user-19.png" width="75%" height="75%">
        </div>
    </div>
    <div class="col-lg-6">
        <div>
          <h1>BIODATA</h1>
          <P>Nama :ria rizkina</P>
          <P>Alamat :kopang</P>
          <P>Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis itaque eveniet ratione accusantium laboriosam optio alias iusto odio veniam eligendi. Officia, beatae consectetur! Quis aperiam doloremque laborum ut, iste aut quod labore tenetur facilis, doloribus in sapiente minus ducimus minima quibusdam delectus assumenda quidem! Nam eligendi voluptates corrupti atque harum? Lorem ipsum dolor sit amet consectetur adipisicing elit. Laboriosam veniam dolorem sint obcaecati tenetur, impedit nisi magni esse, voluptas adipisci laudantium repellendus? Minima alias molestiae dolor. Perferendis hic quasi atque ab fugit saepe soluta tenetur non veritatis aut ratione, odit at possimus odio delectus harum architecto nobis? Praesentium, quam quis.</P>
        </div>
    </div>
  </div>
  </div>
