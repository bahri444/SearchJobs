...
<head>
  ...
  <title>Boxed Layout / Universe Admin</title>
...
<body class="js-loading boxed-layout sidebar-sm"> <!-- add for rounded corners: form-controls-rounded -->
...
<div class="container-fluid container-fh">
  <div class="page-content__header">
    <div>
      <h2 class="page-content__header-heading">Boxed Layout</h2>
    </div>
  </div>
