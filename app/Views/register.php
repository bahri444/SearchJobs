...
<div class="p-signin">
  <form class="p-signin__form">
    <h2 class="p-signin__form-heading">REGISTER SISFO LOKER</h2>
    <div class="p-signin__form-content">
      ...
      <div class="row">
        ...
        <div class="form-group col-md-12">
          <label for="p-signin-set-password">Level</label>
          <input type="email" class="form-control" id="p-signin-set-password" placeholder="level">
        </div>
      </div>
      <div>
